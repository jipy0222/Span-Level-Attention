...
if __name__ == '__main__':
    ...
    #                           [101, 185, 119, 7393, 102],
    #                           [101, 185, 119, 9081, 102],
    #                           [101, 185, 119, 9550, 102],
    #                           [101, 185, 119, 9377, 102],
    #                           [101, 185, 119, 5486, 102],
    #                           [101, 138, 1248, 3450, 102],
    #                           [101, 185, 119, 5004, 102],
    #                           [101, 185, 119, 4775, 102]]).cuda()
    # res = model(example)
    # print(res, res.size())
